...
!
!git $Id$
!svn $Id: inquiry.F 1210 2024-01-03 22:03:03Z arango $
!================================================== Hernan G. Arango ===
...
!
        IF (S(ifile)%ncid.eq.-1) THEN
          ...
          IF (FoundError(exit_flag, NoError, 197, MyFile)) THEN
...
!
     ...
     &                                   'cannot be determined.'
        ...
        END IF
        exit_flag=2
        IF (FoundError(exit_flag, NoError, 424, MyFile)) RETURN
      END IF
...
!
      IF (ncid.eq.-1) THEN
        ...
        IF (FoundError(exit_flag, NoError, 505, MyFile)) THEN
...
!
     ...
     &                            start = (/Trec-1/),                   &
     &                            total = (/1/))
            IF (FoundError(exit_flag, NoError, 579, MyFile)) THEN
