...
!
!git $Id$
!svn $Id: def_info.F 1212 2024-01-26 20:59:21Z arango $
!================================================== Hernan G. Arango ===
...
!
     ...
     &                        TRIM(ncname))
          IF (FoundError(status, nf90_noerr, 239, MyFile)) THEN
...
!
     ...
     &                        TRIM(varname))
          IF (FoundError(status, nf90_noerr, 383, MyFile)) THEN
     ...
     &                        TRIM(RST(ng)%name))
          IF (FoundError(status, nf90_noerr, 418, MyFile)) THEN
