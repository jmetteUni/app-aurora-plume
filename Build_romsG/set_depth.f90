...
!
!git $Id$
!svn $Id: set_depth.F 1210 2024-01-03 22:03:03Z arango $
!=======================================================================
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, model, 12, 55, MyFile)
     ...
     &                     GRID(ng) % z_r,                              &
     &                     GRID(ng) % z_w)
      CALL wclock_off (ng, model, 12, 70, MyFile)
!
      RETURN
...
!
      ...
      UBij=BOUNDS(ng)%UBij
!
      CALL wclock_on (ng, model, 12, 300, MyFile)
     ...
     &                      GRID(ng) % z0_r,                            &
     &                      GRID(ng) % z0_w)
      CALL wclock_off (ng, model, 12, 312, MyFile)
!
      RETURN
